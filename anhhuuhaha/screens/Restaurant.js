        ...
        return (
            <View style={{paddingTop:10}}>
                ...
                >
                    ...
                    >
                        <Text style={{ ...FONTS.h3 }}>Số lượng: {getBasketItemCount()} </Text>
                    ...
                    >
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            />
                            <Text style={{ marginLeft: SIZES.padding, ...FONTS.h4 }}>Địa điểm</Text>
                        </View>
                    ...
                    >
                        ...
                        >
                            <Text style={{ color: COLORS.white, ...FONTS.h2 }}>Mua</Text>
                        </TouchableOpacity>
                    </View>
                </View>
